...
import { BarChart3, Boxes, ClipboardList, Home, LogOut, Menu, ShoppingCart, ShieldCheck, Sparkles, Users, X } from 'lucide-react';
...
export function InventoryShell({ children }: { children: ReactNode }) {
  ...
  const adminView=location==='/admin'&&session?.role==='admin';
